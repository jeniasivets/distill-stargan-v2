...
An educational project that demonstrates the implementation of a knowledge distillation pipeline applied to generative adversarial networks. 

The code is based on the official source implementation of StarGAN v2. Please refer to the software installation section and the datasets downloading section to ensure that all dependencies and training data have been successfully installed and downloaded.

The examples of the knowledge distillation pipeline are implemented in  the `distill_scripts` directory.
