...
args.train_img_dir = 'data/celeba_hq/train'
args.val_img_dir = 'data/celeba_hq/val'
args.checkpoint_dir = 'expr/checkpoints/celeba_hq_student/exp_mse'
args.eval_dir = 'expr/eval/celeba_hq_student/exp_cuda1'
args.sample_every = 4000
...
for i in range(args.resume_iter, args.total_iters):
    ...
    args.num_outs_per_domain = 10  # 5 для ускорения тестирования
